...
<body>
	...
	<nav class="navbar navbar-default">
		...
		<button type="button" class="btn btn-primary" id="createBlock">Create
			Block</button>

		<button type="submit" class="btn btn-info" data-toggle="collapse"
			data-target="#demo" id="add">Add to Block</button>
		<%-- </form:form> --%>
		<script>
			function LoadData() {
				var myDataTable = $("#recommendedBlocks").jsp(
		...
		<div id="demo" class="collapse">
			...
			<button type="submit" class="btn btn-info" id="sub">OK</button>
